                                ...
                                <tr>
                                    ...
                                    <td class="quantity-box">
                                        <form action="{{ url('/cart/updateqty', [$product['product_id']])  }}" method="POST">
                                            @csrf
                                            @method("PUT")
                                            <input type="number" size="4" name="qty" value="{{$product["qty"]}}" min="0" step="1" class="c-input-text qty text"><br><br>
                                    ...
                                    <td class="remove-pr">
                                        <a href="{{ url('/cart/remoteitem', [$product['product_id']])  }}">
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="order-box">
                        ...
                        <div class="d-flex gr-total">
                            <h5>Grand Total</h5>
                            <div class="ml-auto h5">${{Session::has('cart') ?  number_format( Session::get('cart')->totalPrice) : 0}} </div>
                        </div>
                        <hr> </div>
                </div>
